					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li class=<?php echo ($actual_link=='/cedhosting/linuxhosting.php')? "active" : "" ?>><a href="linuxhosting.php">Linux hosting</a></li>
								<li class=<?php echo ($actual_link=='/cedhosting/wordpresshosting.php')? "active" : "" ?>><a href="wordpresshosting.php">WordPress Hosting</a></li>
								<li class=<?php echo ($actual_link=='/cedhosting/windowshosting.php')? "active" : "" ?>><a href="windowshosting.php">Windows Hosting</a></li>
								<li class=<?php echo ($actual_link=='/cedhosting/cmshosting.php')? "active" : "" ?>><a href="cmshosting.php">CMS Hosting</a></li>
							</ul>			
						</li>
